...
public class listmain extends AppCompatActivity implements ProductsAdapter.ClickListener {
    String URL_PRODUCTS;
    String logged="";
...
String district1="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        URL_PRODUCTS = "https://www.grapestechs.com/securemail/Inbox2.php?user="+logged+"";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            ProductsAdapter adapter = new ProductsAdapter(listmain.this, productList);
...
Intent i=new Intent(listmain.this,listedit.class);
i.putExtra("id",a);
i.putExtra("code",b);
i.putExtra("from1",c);
i.putExtra("to1",d);
