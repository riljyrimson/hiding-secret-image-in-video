...
public class Compose2Activity extends AppCompatActivity {
    ...
    public boolean SaveData()
    {
        ...
        String url = "http://www.grapestechs.com/sendmessage.php";
        ...
        params.add(new BasicNameValuePair("fromm", logged));
        params.add(new BasicNameValuePair("too", txtto.getText().toString()));
        ...
        {
            Toast.makeText(Compose2Activity.this, "Save Data Successfully", Toast.LENGTH_SHORT).show();

            Intent i=new Intent(Compose2Activity.this,OptionsActivity.class);
