...
public class SentProductsAdapter extends RecyclerView.Adapter<SentProductsAdapter.ProductViewHolder> {
    ...
    public SentProductsAdapter(Context mCtx, List<Product> productList) {
    ...
    public void onBindViewHolder(ProductViewHolder holder, final int position) {
       ...
       // Glide.with(mCtx)
        ...
        holder.textViewTitle.setText(product.getto1());
